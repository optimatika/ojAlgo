...
/**
 * Forward-compatible SOCP test: Detects and enforces a simple second-order cone constraint. Constraint form:
 * -t^2 + u1^2 + u2^2 <= 0 with objective minimise t. Expected optimum: t = 0, u1 = 0, u2 = 0 (on the
 * boundary); solver may return small positive t maintaining interior.
 */
public class ConicSOCPTest {
    ...
    public void detectsAndSolvesSimpleSOCConstraint() {
        ...
        Variable t = model.addVariable("t").weight(1.0);
