...
/**
 * Mixed linear + SOC test: Ensures simultaneous presence of bound-derived {@link ConicSolver.NonnegativeCone}
 * and auto-detected {@link ConicSolver.SecondOrderCone} does not break feasibility or residual logic. The
 * model minimises t + x subject to:
 * <ul>
 * <li>SOC: -t^2 + u_1^2 + u_2^2 <= 0</li>
 * <li>Bounds: 0 <= x <= 2, t >= 0 (u1, u2 free)</li>
 * <li>Equality: x + u1 = 1 (exercise equality residual path)</li>
 * </ul>
 * Expected outcome: feasible interior point with t >= sqrt(u1^2+u2^2) and bounded residuals.
 */
public class ConicMixedLinearSOCTest {
    ...
    public void testMixedLinearAndSOC() {
        ...
        // Equality approximately satisfied: x + u1 = 1 (soft check until predictor–corrector lands).
        ...
        // Residual norms: primal moderate, dual finite.
