 ...
 * blocks.
 * <p>
 * Inline commentary is kept to a minimum per project guidance; additional explanatory detail is captured in
 * the dedicated workplan document.
 */
public class ConicIntegrationMappingTest {
    ...
    public void mapsDiagonalQuadraticInequalityToSecondOrderCone() {
        ...
        // A and b enforce s = -x for the SOC block variables -> rows with -1 on corresponding columns.
    ...
    public void mapsLinearBoundsAndConstraintsToNonnegativeCone() {
        ...
        // One nonnegative cone covering all linear inequalities and bounds.
        TestUtils.assertEquals(1, p.cones.size());
        ...
        // Equality row represents x + z = 0 (checked sparsely to avoid order assumptions).
    ...
    public void mapsQuadraticObjectiveToQandc() {
        ...
        // Define objective as a proper weighted expression so aggregation works.
