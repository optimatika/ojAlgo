...
public class KMeansTest extends ClusterTests {
    ...
    void testBasic() {
        ...
        Set<ClusterTests.Point> cluster1 = Set.of(new KMeansTest.Point(1, 1), new KMeansTest.Point(2, 1), new KMeansTest.Point(4, 3),
                new KMeansTest.Point(5, 4));
        Set<ClusterTests.Point> cluster2 = Set.of(new KMeansTest.Point(8, 7), new KMeansTest.Point(7, 8));

        List<ClusterTests.Point> points = new ArrayList<>();
        ...
        TestUtils.assertEquals(k, clusters.size());
